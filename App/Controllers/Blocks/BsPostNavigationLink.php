...
if (!class_exists('\\BBFSEPlug\\App\\Controllers\\Blocks\\BsPostNavigationLink')) {
    /**
     * Bootstrap post navigation link class.
     * 
     * @since 0.0.1
     */
    class BsPostNavigationLink implements \BBFSEPlug\App\Controllers\ControllerInterface
    {
