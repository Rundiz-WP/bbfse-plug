...
if (!class_exists('\\BBFSEPlug\\App\\Controllers\\Blocks\\BsNavbarResponsiveWrapper')) {
    /**
     * Bootstrap navbar responsive wrapper class.
     * 
     * @since 0.0.1
     */
    class BsNavbarResponsiveWrapper implements \BBFSEPlug\App\Controllers\ControllerInterface
    {
