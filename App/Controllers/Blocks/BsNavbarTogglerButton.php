...
if (!class_exists('\\BBFSEPlug\\App\\Controllers\\Blocks\\BsNavbarTogglerButton')) {
    /**
     * Bootstrap navbar toggler button class.
     * 
     * @since 0.0.1
     */
    class BsNavbarTogglerButton implements \BBFSEPlug\App\Controllers\ControllerInterface
    {
